          ...
          <div style="width:90%;margin:40% auto">
            ...
            <el-form ref="loginform" :model="loginform" label-width="80px" :rules="rules">
              <el-form-item label="用户名" prop="userName">
                <!-- <el-input v-if="this.$route.params == '{}' " v-model="loginform.re_userName"></el-input> -->
...
data() {
    return {
      loginform: {
        userName:this.$route.params.registerForm.userName,
        password:this.$route.params.registerForm.password,
        // userName:"",
        // password:"",
        checked: true
      },
